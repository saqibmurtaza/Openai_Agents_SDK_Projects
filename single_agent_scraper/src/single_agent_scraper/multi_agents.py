...
from tools.shopify_scrapper import scrape_shopify_collection, extract_product_data
from tools.save_to_google import save_to_sheet
from src.config_agent import config
...
#     instructions=(
#         "You are a router agent. You use the tools given to you to scrape data and save to Google Sheet."
#         "you call the relevant tools in order."
#         "Do not add extra explanations or text."
#         "Return the final save status message from data_writer_agent."
#     ),
#     tools=[
#         shopify_agent.as_tool(
#             tool_name="scrape_shopify_collection",
#             tool_description="Scrape data from shopify_url",
#         ),
